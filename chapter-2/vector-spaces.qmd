...
### ✍️ **Example 1**: a linear combination in $\mathbb{R}^2$?
...
### ✍️ **Example 2**: a linear combination in $\mathbb{R}^3$?
...
## 🏷️ Linear independence and dependence
...
### ✍️ **Example 1**: linear dependence in $\mathbb{R}^2$
...
### ✍️ **Example 2**: linear dependence in $\mathbb{R}^3$
...
### ✍️ **Example 3**: linear dependence in $\mathbb{R}_{[x]}$
