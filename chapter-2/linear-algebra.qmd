...
as [basis vectors](chapter-2/vector-spaces.html#basis-dimension) of a [vector space](chapter-2/vector-spaces.html#vector-space-axioms) of polynomials, exactly those notions that are defined in this chapter on linear algebra! 
...
=
\left(1,1,\dfrac{1}{2!},\dfrac{1}{3!},\ldots\right).
$$
