...
::: {.callout-note}
[Noah Jang](https://www.linkedin.com/in/noah-jang-2111392ba/) is the original creator of the exposition and examples referenced here. The interactive implementations, animations, additional explanations, and contextual material on this site are my own work.

The original exposition and examples can be found back in Noah Jang's video [Proof of Fermat Last Theorem FROM SCRATCH](https://www.youtube.com/watch?v=9f-hGSh8lF0).
:::
...
* [Abstract algebra](chapter-3/abstract-algebra.qmd) ([groups](chapter-3/groups.qmd) and [Galois theory](chapter-3/galois-theory.qmd)),
* Elliptic curves,
* Modular forms
